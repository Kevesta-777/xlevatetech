      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center max-w-7xl mx-auto">
          <div className="space-y-4 sm:space-y-5 md:space-y-6 animate-fade-in text-left max-w-2xl mx-auto md:mx-0 w-full">
            ...
            <div className="pb-3">
              <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-200 leading-[1.3]">
                Founder-led startup with enterprise experience. Get early access to cutting-edge automation for Finance, Healthcare and Real Estate teams.
              </h2>
            </div>
            ...
            <div className="py-3 animate-fade-in" style={{ animationDelay: '1s' }}>
              <div className="flex items-center justify-start gap-4 mb-2">
                <span className="text-xl text-gray-500 line-through">$3,500</span>
                <span className="text-3xl font-bold text-elevate-accent">FREE</span>
              </div>
            ...
            {/* Dual CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 pb-3 animate-fade-in w-full max-w-lg mx-auto sm:max-w-none" style={{ animationDelay: '1.3s' }}>
              <Button 
                onClick={handleGetAssessment} 
                className="bg-[#0A2463] hover:bg-[#1E3A8A] text-white font-bold text-sm sm:text-base px-6 py-3 sm:px-8 sm:py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 min-h-[44px] w-full sm:w-auto sm:flex-1 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[#70EDFF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1f2c]" 
                aria-label="Get your free 30-minute strategy session"
              >
              ...
              <Button
                ...
                className="border-2 border-elevate-accent text-elevate-accent hover:bg-elevate-accent hover:text-elevate-accent-foreground bg-transparent hover:text-white font-bold text-sm sm:text-base px-6 py-3 sm:px-8 sm:py-4 rounded-lg transition-all duration-300 min-h-[44px] w-full sm:w-auto sm:flex-1 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[#70EDFF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1f2c]"
