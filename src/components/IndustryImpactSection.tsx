...
const IndustryImpactSection = () => {
  const impactData = [{
    ...
    status: "Data Migration - Date Imported and Validation",
    progress: 90,
    phase: "4",
    weeks: "Week 9/10 - Starting 6/10/25",
    icon: Building,
    ...
    progress: 100,
    phase: "3",
    weeks: "Week 3/3 - Completed 7/28/25",
    icon: Bot,
    ...
    progress: 0,
    phase: "1",
    weeks: "Week 0/8 - Pilot Programs Available",
    icon: Pill,
    challengeIcon: Cog,
    solutionIcon: Zap,
