...
const services = [{
  ...
  pricingTiers: [{
    name: "Starter Plan",
    price: "$3,999 setup + $499/month",
    features: "Basic AI chatbot, workflow automation, 2-3 week delivery"
  }, {
    name: "Professional Plan",
    price: "$5,999 setup + $699/month",
    features: "Advanced AI workflows, real-time monitoring"
  }, {
    name: "Premium Plan",
    price: "$9,999 setup + $999/month",
    features: "Full AI ecosystem, predictive analytics, dedicated support"
  }]
}, {
  ...
  pricingTiers: [{
    ...
    features: "Up to 50GB data, basic validation, 1-week completion"
  }, {
    name: "Complex Migration",
    price: "$6,999 one-time",
    features: "Unlimited data, advanced mapping, zero downtime guarantee"
  }, {
    name: "Advanced Migration",
    price: "Custom pricing",
    features: "Multi-system integration, custom APIs, ongoing support"
  }]
}, {
  ...
  pricingTiers: [{
    ...
    price: "$3,499 setup + $599/month",
    features: "Workflow mapping, efficiency recommendations"
  }, {
    name: "Full Optimization",
    price: "$5,999 setup + $899/month",
    features: "Process redesign, automation implementation"
  }, {
    name: "Continuous Improvement",
    price: "$9,999 setup + $1,199/month",
    features: "Ongoing optimization, performance monitoring"
  }]
}, {
  ...
  pricingTiers: [{
    ...
    price: "$1,999 per project",
    features: "Basic functionality, compatibility testing"
  }, {
    name: "Comprehensive QA",
    price: "$3,999 per project",
    features: "Full test suite, automated frameworks, accessibility compliance"
  }, {
    name: "Premium QA",
    price: "$5,999 per project",
    features: "Advanced testing, performance optimization, security audits"
  }]
}];
const ServicesSection = () => {
  ...
  return <section id="services" ref={sectionRef} className="section-padding bg-gradient-to-br from-elevate-accent/10 to-elevate-accent/5 text-white relative z-10 scroll-mt-20 opacity-0" aria-labelledby="services-heading">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12">
          {services.map((service, index) => <Card key={index} className="service-card bg-elevate-dark backdrop-blur-sm border border-elevate-accent/20 rounded-xl shadow-lg hover:shadow-xl hover:border-elevate-accent/40 transition-all duration-300 opacity-0 transform hover:translate-y-[-4px] h-full">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mb-4 space-y-2">
                  {service.pricingTiers.map((tier, tierIndex) => <div key={tierIndex} className="p-3 bg-elevate-accent/10 border border-elevate-accent/20 rounded-lg">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <a href="https://calendly.com/raj-dalal-xlevatetech" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#70EDFF] hover:bg-[#5BBFEA] text-[#0A2463] font-bold text-sm sm:text-base lg:text-lg px-6 py-3 sm:px-8 sm:py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 min-h-[44px] w-full sm:w-auto">Get Your Automation Assessment</a>
            <a href="/services" className="inline-flex items-center justify-center gap-2 bg-elevate-dark/50 hover:bg-elevate-dark/70 text-gray-300 border border-elevate-accent/20 hover:border-elevate-accent/40 font-bold text-sm sm:text-base lg:text-lg px-6 py-3 sm:px-8 sm:py-4 rounded-lg transition-all duration-300 min-h-[44px] w-full sm:w-auto">See Pricing & ROI Calculator</a>
          </div>
        </div>
      </div>
    </section>;
