  ...
  "inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        tag: "border-transparent bg-primary/80 text-primary-foreground text-[10px] px-1.5 py-0.5",
        success: "border-green-500/30 bg-green-600/20 text-green-400 hover:bg-green-600/30",
      },
    },
    defaultVariants: {
      variant: "default",
