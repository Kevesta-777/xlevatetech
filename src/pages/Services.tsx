...
const Services = () => {
      ...
      services: [
        {
          ...
          expertise: [
            "AI Development: OpenAI GPT-4, Claude, Custom Models",
            "Multi-platform: Web, mobile, messaging platforms",
            "Analytics: Performance tracking, conversation insights",
            "Integration: CRM systems, calendars, databases"
          ]
        },
        {
          ...
          expertise: [
            "Automation Tools: Zapier, Make.com, n8n workflows",
            "Integration APIs: Custom connectors, data flow",
            "Performance Monitoring: KPI tracking, optimization",
            "Business Intelligence: Process analytics, insights"
          ]
        },
        {
          ...
          expertise: [
            "Analytics Platforms: Tableau, Power BI, custom solutions",
            "Predictive Modeling: Machine learning, forecasting",
            "Data Integration: Multiple sources, real-time processing",
            "Custom Reporting: Executive dashboards, KPI tracking"
          ]
        }
      ]
    },
      ...
      services: [
        {
          ...
          expertise: [
            "Platform Migrations: Excel to modern systems",
            "Data Processing: Validation, cleanup, transformation",
            "System Integration: APIs, databases, cloud platforms",
            "Quality Assurance: Zero data loss protocols"
          ]
        },
        {
          ...
          expertise: [
            ...
            "Security: OAuth, API key management, encryption",
            "Documentation: Comprehensive guides, testing suites"
          ]
        }
      ]
    },
      ...
      services: [
        {
          ...
          expertise: [
            "Monitoring Tools: Custom dashboards, real-time alerts",
            "Performance Analytics: KPI tracking, trend analysis",
            "Data Integration: Multiple sources, automated reporting",
        ...
        },
        {
          ...
          expertise: [
            "Testing Frameworks: Automated and manual protocols",
  ...
  return (
    <div className="min-h-screen bg-elevate-dark text-white mobile-section">
        ...
        <section className="bg-gradient-to-br from-elevate-dark via-elevate-dark to-blue-900/20 py-8 md:py-20 mobile-container">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-lg md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Research-backed competitive pricing 30-40% below enterprise rates
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="text-2xl md:text-4xl font-bold text-elevate-accent mb-2">30-70%</div>
                <div className="text-gray-300 text-sm md:text-base">Below Market Rates</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-4xl font-bold text-elevate-accent mb-2">2-4 Weeks</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                className="cta-btn bg-elevate-accent hover:bg-elevate-accent/80 text-elevate-dark font-semibold px-6 md:px-8 py-3 rounded-lg transition-all duration-300"
              ...
              <Button 
                ...
                onClick={() => document.getElementById('pricing-analysis')?.scrollIntoView({ behavior: 'smooth' })}
        ...
        <section id="services" className="py-8 md:py-20 mobile-section">
          <div className="container mx-auto px-4 md:px-6">
            {serviceCategories.map((category, categoryIndex) => (
              <div key={categoryIndex} className="mb-12 md:mb-20 last:mb-0">
                <div className="text-center mb-8 md:mb-16">
                  <h2 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 text-white">
                ...
                <div className="space-y-8 md:space-y-16">
                  {category.services.map((service, serviceIndex) => (
                    <Card key={serviceIndex} className="bg-elevate-dark/70 border-elevate-accent/20 overflow-hidden service-card-mobile">
                            ...
                            <div className="lg:col-span-2">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 md:mb-8">
                                {service.pricingTiers.map((tier, tierIndex) => (
                                  <Card key={tierIndex} className="bg-gray-800/50 border-gray-600 p-3 md:p-4">
                                    <div className="text-center">
                            ...
                            <div className="lg:col-span-1">
                              <Card className="bg-gray-800/50 border-gray-600 p-4 md:p-6 h-fit">
                                ...
                                <ul className="space-y-3">
                                  {service.expertise.map((item, expIndex) => (
                                    <li key={expIndex} className="text-gray-300 text-xs md:text-sm leading-relaxed">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {pricingIncentives.map((incentive, index) => (
                <Card key={index} className="bg-elevate-dark border-elevate-accent/20 p-4 md:p-6 text-center hover:border-elevate-accent/40 transition-all duration-300">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                aria-label="Start your automation project today"
              >
                Start Your Project
              </Button>
              <Button 
