...
-- Update existing entries with more detailed answers
UPDATE knowledge_base 
SET answer = 'We deliver custom AI workflows, data migrations, compliance readiness services, QA strategy, and process optimization. Our solutions typically reduce process time by 40-70% and errors by 30-50%.'
WHERE question LIKE '%services%' AND category = 'general';

-- Add more specific FAQ entries
INSERT INTO knowledge_base (question, answer, category) VALUES
