-- Add knowledge base data for improved AI responses
...
Would you like specific examples from your industry?', 'definitions'),
...
What type of processes are you looking to automate?', 'costs'),
...
Which systems are you looking to connect?', 'implementation'),
...
What type of workflow are you considering for automation?', 'planning'),
...
Our ROI calculator provides specific estimates based on your inputs. Have you tried our calculator yet?', 'roi'),
...
Ready to discuss your specific requirements? Please email raj.dalal@xlevatetech.com or schedule a consultation to get started.', 'sales');
